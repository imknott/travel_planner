export const translations = {
    en: {
      ...
      login: 'Login',
      signup: 'Sign Up',
      features: ['✔️ No subscription', '✔️ Free to use', '✔️ Open source'],
    ...
    es: {
      ...
      signup: 'Regístrate',
      features: ['✔️ Sin suscripción', '✔️ Gratis', '✔️ Código abierto'],
    ...
    hi: {
      ...
      login: 'लॉग इन करें',
      signup: 'साइन अप करें',
      features: ['✔️ कोई सदस्यता नहीं', '✔️ उपयोग करने के लिए मुफ़्त', '✔️ ओपन सोर्स'],
    ...
    ar: {
      ...
      login: 'تسجيل الدخول',
      signup: 'إنشاء حساب',
      features: ['✔️ بدون اشتراك', '✔️ مجاني للاستخدام', '✔️ مفتوح المصدر'],
    ...
    pt: {
      ...
      login: 'Entrar',
      signup: 'Cadastrar-se',
      features: ['✔️ Sem assinatura', '✔️ Gratuito', '✔️ Código aberto'],
    ...
    ru: {
      ...
      features: ['✔️ Без подписки', '✔️ Бесплатно', '✔️ С открытым исходным кодом'],
    ...
    ja: {
      ...
      login: 'ログイン',
      signup: '登録',
      features: ['✔️ サブスクリプション不要', '✔️ 無料で使える', '✔️ オープンソース'],
    ...
    fr: {
      ...
      login: 'Connexion',
      signup: 'S’inscrire',
      features: ['✔️ Sans abonnement', '✔️ Gratuit', '✔️ Open source'],
    ...
    de: {
      ...
      login: 'Anmelden',
      signup: 'Registrieren',
      features: ['✔️ Kein Abo', '✔️ Kostenlos', '✔️ Open Source'],
